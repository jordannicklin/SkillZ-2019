...
{
    class ElfBuildManaFountainsAtStartOfGame : Heuristic
    {
        private int maxTurn;
        private int maxManaFountains;

        public ElfBuildManaFountainsAtStartOfGame(float weight, int maxTurn, int maxManaFountains) : base(weight)
        {
        ...
        public override float GetScore(VirtualGame virtualGame)
        {
            ...
            return virtualGame.futureManaFountains.Count;
        }
    }
}
