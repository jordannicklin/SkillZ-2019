...
{
    class ElfCastSpeedUpWhenBeingChased : Heuristic
    {
        ...
        public ElfCastSpeedUpWhenBeingChased(float weight, float radius, float aloneRadius, float nearMapEdgesPadding) : base(weight)
        {
            this.radius = radius;
